# Mallett Made Solutions — Radiant Barrier Article Publishing Queue

## How This Works
1. Every Tuesday at 8 AM a GitHub Action automatically opens a PR for the next article
2. Open the PR → click the article link in the description to read the fully rendered markdown
3. **To approve:** Merge the PR
4. **To request changes:** Leave a comment on the PR, then open Claude Code and say `revise [article title]: [your feedback]`
5. **To publish in Squarespace after merging:**
   - Open the article file in the repo → click **Raw** → copy all
   - Squarespace: New Blog Post → add **Markdown block** → paste → Publish

---

## Publishing Queue (24 Articles)

Priority order: high-intent commercial articles first, then education, then DIY, then proof.
...
| 3 | Radiant Barrier Cost in North Carolina (2026) | pillar-4-proof-results/radiant-barrier-cost-north-carolina-2026.md | in-review | 2026-07-14 | |published |
...
| 18 | Attic Temperature Before and After Radiant Barrier | pillar-4-proof-results/attic-temperature-before-after-radiant-barrier.md | pending | | | |
| 19 | Radiant Barrier vs. Insulation | pillar-2-radiant-barrier-education/radiant-barrier-vs-insulation.md | pending | | | |
| 20 | Radiant Barrier Pros and Cons | pillar-2-radiant-barrier-education/radiant-barrier-pros-and-cons.md | pending | | | |
| 21 | How Hot Does an Attic Get? | pillar-1-attic-heat/how-hot-does-an-attic-get.md | pending | | | |
| 22 | What Temperature Should My Attic Be? | pillar-1-attic-heat/what-temperature-should-my-attic-be.md | pending | | | |
| 23 | Why Can't My Home Stay Cool? (Raleigh-Durham) | pillar-1-attic-heat/why-cant-my-home-stay-cool-raleigh-durham.md | pending | | | |
| 24 | Radiant Barrier in Hot-Humid Climates: DOE Data | pillar-2-radiant-barrier-education/radiant-barrier-hot-humid-climates-doe-data.md | pending | | | |
